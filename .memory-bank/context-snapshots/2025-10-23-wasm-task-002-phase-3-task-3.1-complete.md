...
- **Path:** `.memory-bank/context_snapshots/2025-10-23_wasm_task_002_phase_3_planning_complete.md`
- **Size:** 760 lines
...
- **Path:** `.memory-bank/workspace/shared_patterns.md`
...
- **Path:** `.memory-bank/workspace/microsoft_rust_guidelines.md`
...
- **Path:** `.memory-bank/workspace/documentation_terminology_standards.md`
...
- **Path:** `.memory-bank/sub_projects/airssys-wasm/progress.md`
...
- **Path:** `.memory-bank/sub_projects/airssys-wasm/tasks/task_002_wasm_runtime_implementation.md`
