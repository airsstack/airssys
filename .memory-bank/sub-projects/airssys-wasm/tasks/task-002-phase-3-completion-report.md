...
- `.memory-bank/sub_projects/airssys-wasm/docs/debts/_index.md` (updated)

**Files Created:**
- `.memory-bank/sub_projects/airssys-wasm/docs/debts/debt_wasm_002_epoch_preemption_future_enhancement.md`
...
1. **`.memory-bank/sub_projects/airssys-wasm/docs/debts/_index.md`**
