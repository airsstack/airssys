//! Timeout handling implementation for pending requests.
//!
...
#[cfg(test)]
use super::correlation_impl::CorrelationTracker;
...
/// Implement trait for dependency injection
#[async_trait]
impl crate::core::timeout_trait::TimeoutHandlerTrait for TimeoutHandler {
    fn new() -> Self {
        TimeoutHandler::new()
    }
