...
impl MessagingService {
    ...
    // Methods for Phase 2/3 integration
    // These are marked as dead_code until Phase 2 and Phase 3 are complete
    // Task plan reference: WASM-TASK-HOTFIX-001 Phase 2 (Task 2.1)
