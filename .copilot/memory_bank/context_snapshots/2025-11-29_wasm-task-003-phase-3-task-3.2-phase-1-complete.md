...
cat .copilot/memory_bank/sub_projects/airssys-wasm/active_context.md
```
...
- `.copilot/memory_bank/sub_projects/airssys-wasm/active_context.md`
- `.copilot/memory_bank/sub_projects/airssys-wasm/progress.md`

**Task Documentation:**
- `.copilot/memory_bank/sub_projects/airssys-wasm/tasks/task_003_phase_3_implementation_plan.md`
- `.copilot/memory_bank/sub_projects/airssys-wasm/tasks/task_003_phase_3_task_3.2_permission_system.md`

**Knowledge Documentation:**
- `.copilot/memory_bank/sub_projects/airssys-wasm/docs/knowledges/knowledge_wasm_005_permission_system_architecture.md`
- `.copilot/memory_bank/sub_projects/airssys-wasm/docs/adr/adr_wasm_005_capability_based_security.md`
...
**Storage:**
- Location: `.copilot/memory_bank/context_snapshots/`
