...
**Primary Guide**: `.copilot/memory_bank/sub_projects/airssys-wasm/docs/knowledges/knowledge_wasm_016_actor_system_integration_implementation_guide.md`
...
**Task Specification**: `.copilot/memory_bank/sub_projects/airssys-wasm/tasks/task_004_block_3_actor_system_integration.md`
...
**Code Standards**:
- `.copilot/memory_bank/workspace/shared_patterns.md`: §2.1-§5.1 (imports, modules, dependencies)
- `.copilot/memory_bank/workspace/microsoft_rust_guidelines.md`: Production Rust standards
...
- `.copilot/memory_bank/sub_projects/airssys-wasm/progress.md` - Add Task 1.2 completion entry
- `.copilot/memory_bank/sub_projects/airssys-wasm/active_context.md` - Update to Task 1.3 focus
- `airssys-wasm/src/actor/child_impl.rs` - Add rustdoc examples
- `.copilot/memory_bank/sub_projects/airssys-wasm/tasks/task_004_block_3_actor_system_integration.md` - Mark Task 1.2 complete
...
1. **KNOWLEDGE-WASM-016** - Actor System Integration Implementation Guide
   - Location: `.copilot/memory_bank/sub_projects/airssys-wasm/docs/knowledges/knowledge_wasm_016_actor_system_integration_implementation_guide.md`
   - Section 2.1 (lines 209-437): Child Trait Implementation
   - Section 3.1 (lines 439-638): Testing Strategies

2. **WASM-TASK-004** - Block 3: Actor System Integration
   - Location: `.copilot/memory_bank/sub_projects/airssys-wasm/tasks/task_004_block_3_actor_system_integration.md`
   - Phase 1 Overview (lines 88-133)
...
### Code Standards
1. **Workspace Shared Patterns** - `.copilot/memory_bank/workspace/shared_patterns.md`
